...
public class AirMapType {
    ...
    public String getMapData(Resources resources) {
        return AirMapUtils.getStringFromFile(resources, fileName).replace("MAPURL", mapUrl).replace("LANGTOKEN", Locale.getDefault().getLanguage()).replace("REGIONTOKEN", Locale.getDefault().getCountry());
    }
