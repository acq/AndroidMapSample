...
public class AirMapView extends FrameLayout implements OnCameraChangeListener, OnMapClickListener, OnMapMarkerClickListener, OnMapLoadedListener, OnInfoWindowClickListener {
